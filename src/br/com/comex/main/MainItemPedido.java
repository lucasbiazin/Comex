...
public class MainItemPedido {
	...
	public static void main(String[] args) {
		...
		Produto produto2 = new Produto("Playstation 5  m.física", "Video-Games", 3970.00, 9, categoria3);
		Produto produto3 = new Produto("Iphone 13 Pro Max", "Iphone", 8900.00, 4, categoria3);
