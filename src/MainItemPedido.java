...
public class MainItemPedido {
	...
	public static void main(String[] args) {
		Pedido pedido1 = new Pedido(1, "21/09/2022 10h28", new Cliente(1, "Ana", "111.111.111-11", "(44) 11111-1111",
				"Rua da praia", 77, "Casa", "Porto Belo", "Florianopólis", "Santa Catarina"));

		Pedido pedido2 = new Pedido(2, "21/09/2022 11h35", new Cliente(2, "Eli", "222.222.222-22", "(11)1111-1111",
				"Rua Barbosa Silva", 23, "Casa", "Vila Araújo", "São José", "SP"));

		Pedido pedido3 = new Pedido(3, "21/09/2022 14h40", new Cliente(3, "Gabi", "333.333.333-33", "(44)33333-3333",
				"Avenida Tricolor", 1930, "Casa", "Morumbi", "São Paulo", "São Paulo"));

		Pedido pedido4 = new Pedido(3, "21/09/2022 14h40", new Cliente(3, "Gabi", "333.333.333-33", "(44)33333-3333",
				"Avenida Tricolor", 1930, "Casa", "Morumbi", "São Paulo", "São Paulo"));
		...
		ItemPedido itempedido1 = new ItemPedido(1, 230.00, 2, produto1, pedido1, 0.10, 1);
		ItemPedido itempedido2 = new ItemPedido(2, 3970.00, 1, produto2, pedido2, 0.10, 1);
		ItemPedido itempedido3 = new ItemPedido(3, 2900.00, 2, produto3, pedido3, 0.05, 1);
		ItemPedido itempedido4 = new ItemPedido(4, 0.20, 22, produto4, pedido4, 0, 0);
		...
		System.out.println("Preço total : " + String.format("%.2f", itempedido1.SemDesconto()));
		System.out.println("Preço promocional: " + String.format("%.2f", itempedido1.filtraDescontos()));
		...
		System.out.println("Preço total : " + String.format("%.2f", itempedido2.SemDesconto()));
		System.out.println("Preço promocional: " + String.format("%.2f", itempedido2.filtraDescontos()));
		...
		System.out.println("Preço total : " + String.format("%.2f", itempedido3.SemDesconto()));
		System.out.println("Preço  promocional: " + String.format("%.2f", itempedido3.filtraDescontos()));
		...
		System.out.println("Preço total : " + String.format("%.2f", itempedido4.SemDesconto()));
		System.out.println("Preço  promocional: " + String.format("%.2f", itempedido4.filtraDescontos()));
